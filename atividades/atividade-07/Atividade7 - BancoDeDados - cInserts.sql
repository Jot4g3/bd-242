...
--
-- Host: mysql:3306
-- Tempo de geração: 05/02/2025 às 14:04
...
(1, 'João Silva Comércio', 'Silva', 'João', '85998765432', 'Av. Beira-Mar, 1500', 'Sala 205', 'Fortaleza', 'CE', '60165-121', 'Brasil', 1, 50000),
(2, 'Maria Flores e Decorações', 'Flores', 'Maria', '11987654321', 'Rua das Rosas, 250', 'Apto 102', 'São Paulo', 'SP', '04563-002', 'Brasil', 2, 25000),
...
(1, 'Bezerra', 'Carlos', '530', 'carlos@gmail.com', 2, NULL, 'Gerente de Vendas'),
...
(11, 'Tênis de Corrida Performance', 6, '1:1', 'Nike', 'Tênis leve e confortável para alto desempenho', 150, 699.99, 849.99),
